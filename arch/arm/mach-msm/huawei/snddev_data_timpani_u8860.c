...
#include "timpani_profile_7x30_u8860.h"
...
static struct adie_codec_action_unit ispkr_48KHz_osr256_actions[] =
	SPEAKER_PRI_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispkr_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispkr_settings,
	.setting_sz = ARRAY_SIZE(ispkr_settings),
};

static struct snddev_icodec_data snddev_ispkr_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MUSIC_MONO,
	.profile = &ispkr_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_ispkr_device = {
	.name = "snddev_icodec",
	.id = 8,
	.dev = { .platform_data = &snddev_ispkr_data },
};
